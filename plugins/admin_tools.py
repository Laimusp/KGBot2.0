...
@KGBot.on_message(filters.me & filters.command('unban', KGBot.prefix))
...
@KGBot.on_message(filters.me & filters.command('kick', KGBot.prefix))
...
@KGBot.on_message(filters.me & filters.command('mute', KGBot.prefix) & filters.reply)
