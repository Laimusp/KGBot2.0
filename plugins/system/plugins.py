...
@KGBot.on_message(filters.me & filters.command('loadmod'))
...
@KGBot.on_message(filters.me & filters.command('delmod'))
...
@KGBot.on_message(filters.me & filters.command('fdelmod'))
...
@KGBot.on_message(filters.me & filters.command('recovmod'))
