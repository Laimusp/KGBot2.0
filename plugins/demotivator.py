...
class Help:
    author = 'Koban'
    modules_description = 'Модуль для создания демотиваторов'
    commands_description = {
        'demotivator [текст] [второй текст (на новой строке)]': 'Создать демотиватор'
    }


@KGBot.on_message(filters.me & filters.command("demotivator"))
