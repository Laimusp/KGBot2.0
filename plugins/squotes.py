...
@KGBot.on_message(filters.me & filters.command('sq', KGBot.prefix))
...
@KGBot.on_message(filters.me & (filters.command('rsq', KGBot.prefix)))
...
@KGBot.on_message(filters.me & filters.command('msq', KGBot.prefix))
